...
app.post('/session_set', async (req, res) => {
  let {  user_name, user_id, psy_id, session_date, session_time } = req.body;
  ...
  try {
    // Extract user data from the request body
    const { user_name, user_id, psy_id, session_date, session_time  } = req.body;

    // Call the SessionData function to insert the data into the database
    await insertSessionData( session_id, user_name, user_id, psy_id, session_date, session_time);
